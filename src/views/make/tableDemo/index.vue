...
const state = reactive<TableDemoState>({
	tableData: {
      ...
      { key: 'counterparty', colWidth: '200px', title: '交易对方', type: 'text', isCheck: true },
      { key: 'goods', colWidth: '200px', title: '商品', type: 'text', isCheck: true },
      { key: 'amount', colWidth: '100px', title: '金额', type: 'text', isCheck: true, style: 'text-align: right;' },
      { key: 'pay_method', colWidth: '160px', title: '支付方式', type: 'text', isCheck: true },
    ],
		// 配置项（必传）
		config: {
			total: 0, // 列表总数
